<div class="vps-main-page-div">
  ...
  <div class="vps-main-page-greeting">
    <h1>Hello there 
      <span class="vps-username-box"><?php echo esc_html(wp_get_current_user()->user_nicename); ?></span>
    </h1>
  </div> 
  ...
  <div>
   <p>Here, you can create, update, insert and manage all of your video projects.</p></div>
  <div>
    <p>
      We hope this page makes it very quick and very easy to manage bespoke content for your site all in 1 place.
    </p>
  </div>
